...
namespace MultiLanguageApp.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,UsedInCountry,Lifetime,Continent")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,UsedInCountry,Lifetime,Continent")] Language language)
        {
            if (id != language.Id)
            {
                return NotFound();
